...
Ressources tierces effectivement incluses dans le projet. Licence indiquée pour chaque ligne — à mettre à jour à chaque ajout ou retrait.
 
## Modèles 3D
 
- **Stylized Nature MegaKit** — Quaternius — **CC0** (forêt)
  [quaternius.com/packs/stylizednaturemegakit.html](https://quaternius.com/packs/stylizednaturemegakit.html)
- **Modular Sci-Fi MegaKit** — Quaternius — **CC0** (bunker intérieur + extérieur)
  [quaternius.com](https://quaternius.com/)
- **Resource Bits** — Kay Lousberg — **CC0** (feu de camp)
