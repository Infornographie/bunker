...
- [ ] Composer les reliefs en `max()` et non en somme — à deux massifs, un point situé dans les deux additionne les hauteurs. Même règle pour `massif_influence`, que les biomes lisent. **Change la carte** : nouvelle référence d'empreinte à écrire après validation à l'œil.
